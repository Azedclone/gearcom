INSERT INTO `gearcom`.`user` (`address`, `name`, `password`, `phone`, `username`)
...
INSERT INTO `gearcom`.`category` (`name`)
VALUES ('Desktop Computers'),
       ...
       ('Software');
INSERT INTO `gearcom`.`product` (`description`, `image_url`, `name`, `price`, `category_id`)
...
INSERT INTO `gearcom`.`bill` (`created_at`, `user_id`)
VALUES ('2020-01-01 12:00:00', 1),
       ('2020-02-15 08:30:00', 2),
       ('2020-03-20 16:45:00', 3),
       ('2020-04-05 14:15:00', 4),
       ('2020-05-10 10:00:00', 5),
       ('2021-06-12 09:30:00', 6),
       ('2021-07-25 13:45:00', 7),
       ('2021-08-28 11:00:00', 8),
       ('2021-09-03 17:15:00', 9),
       ('2021-10-09 10:30:00', 10),
       ('2022-11-10 14:45:00', 11),
       ('2022-12-15 08:00:00', 12),
       ('2022-01-20 16:30:00', 13),
       ('2022-02-25 14:15:00', 14),
       ('2022-03-30 12:00:00', 15),
       ('2023-04-12 08:30:00', 16),
       ('2023-05-25 16:45:00', 17),
       ('2023-06-30 14:15:00', 18),
       ('2023-07-05 10:00:00', 19),
       ('2023-08-10 09:30:00', 20),
       ('2020-09-20 12:00:00', 1),
       ('2021-03-15 08:30:00', 2),
       ('2021-07-05 16:45:00', 3),
       ('2022-04-05 14:15:00', 4),
       ('2022-10-10 10:00:00', 5),
       ('2023-01-18 09:30:00', 6),
       ('2020-08-25 13:45:00', 7),
       ('2021-12-28 11:00:00', 8),
       ('2022-03-03 17:15:00', 9),
       ('2023-02-05 10:30:00', 10),
       ('2020-11-10 14:45:00', 11),
       ('2021-02-15 08:00:00', 12),
       ('2022-01-10 16:30:00', 13),
       ('2020-06-25 14:15:00', 14),
       ('2022-04-30 12:00:00', 15),
       ('2021-11-12 08:30:00', 16),
       ('2022-08-25 16:45:00', 17),
       ('2023-04-30 14:15:00', 18),
       ('2022-12-05 10:00:00', 19),
       ('2021-06-10 09:30:00', 20),
       ('2023-02-20 12:00:00', 1),
       ('2022-09-15 08:30:00', 2),
       ('2020-11-05 16:45:00', 3),
       ('2021-08-05 14:15:00', 4),
       ('2023-01-10 10:00:00', 5),
       ('2022-07-18 09:30:00', 6),
       ('2022-06-25 13:45:00', 7),
       ('2020-10-28 11:00:00', 8),
       ('2022-02-03 17:15:00', 9),
       ('2023-03-05 10:30:00', 10);
INSERT INTO `gearcom`.`bill_detail` (`quantity`, `bill_id`, `product_id`)
VALUES (2, 1, 1),
       (3, 1, 2),
       (1, 2, 1),
       (4, 2, 2),
